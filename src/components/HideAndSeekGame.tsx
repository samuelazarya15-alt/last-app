  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-start bg-amber-50 p-4 relative overflow-hidden">
      <div className="w-full flex justify-between items-center z-10 mb-4">
        ...
        <div className="flex gap-4">
          <div className="bg-white px-4 py-2 rounded-2xl shadow-sm font-bold text-amber-600">
            Level {level}
          </div>
        ...
        <AnimatePresence>
          {options.map((opt) => (
            <motion.button
              ...
              className="absolute text-6xl drop-shadow-lg flex items-center justify-center"
              style={{
                left: `${opt.x}%`,
                top: `${opt.y}%`,
