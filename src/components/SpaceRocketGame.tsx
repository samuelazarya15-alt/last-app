  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-start bg-indigo-950 p-4 relative overflow-hidden">
      ...
      <div className="w-full flex justify-between items-center z-10 mb-4">
        <button 
          onClick={onBack}
          className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center shadow-md text-2xl border border-white/30"
        >
          🏠
        </button>
        <div className="flex gap-4">
          <div className="bg-white/20 backdrop-blur-md px-4 py-2 rounded-2xl shadow-sm font-bold text-indigo-200 border border-white/30">
            Level {level}
          </div>
          <div className="bg-white/20 backdrop-blur-md px-4 py-2 rounded-2xl shadow-sm font-bold text-green-300 border border-white/30">
            Score: {score}
          </div>
        </div>
        <GameTimer 
      ...
      <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl shadow-md border border-white/30 text-center mb-4 z-10">
        <h2 className="text-3xl font-black text-white">
          Category: <span className="text-yellow-400">{targetCategory}</span>
        </h2>
      </div>
          ...
          <AnimatePresence>
            {options.map((opt) => (
              ...
              >
                ...
                <span className="text-xl font-bold text-indigo-100 uppercase">{opt.english}</span>
              </motion.button>
            ))}
          </AnimatePresence>
        </div>
