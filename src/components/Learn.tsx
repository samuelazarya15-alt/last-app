...
export function Learn({ language }: { language: string }) {
  ...
  return (
    <div className="w-full h-full flex flex-col p-4 bg-sky-50 pb-32 pt-8 overflow-hidden">
      <div className="mb-8 sticky top-0 z-10 bg-sky-50/80 backdrop-blur-md pt-2 pb-6 px-4 rounded-b-[3rem]">
        <div className="flex justify-center gap-4 mb-8">
          <motion.button
            ...
            className={`flex items-center px-8 py-4 rounded-[2rem] font-black text-xl transition-all ${
              mode === 'dictionary' 
        ...
        {mode === 'dictionary' && (
          <div className="relative max-w-xl mx-auto">
            <input
              ...
              className="w-full bg-white border-4 border-blue-100 rounded-[2rem] py-5 pl-16 pr-8 text-2xl font-black outline-none focus:border-blue-400 transition-all shadow-lg placeholder:text-blue-200"
            />
        ...
        <div className="flex-1 overflow-y-auto space-y-6 px-4 pb-12">
              ...
              >
                <div className="flex-1">
                  <div className="flex items-baseline gap-3 mb-1">
                    <h3 className="text-3xl font-geez font-black text-gray-800">{word.tigrinya}</h3>
                    <span className="text-lg font-bold text-gray-300 tracking-widest uppercase">{phonetic}</span>
                  </div>
                  <p className="text-xl font-black text-blue-500 tracking-tight">{translation}</p>
                </div>
          ...
          {filteredWords.length === 0 && (
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-center text-gray-300 font-black text-2xl mt-20"
            >
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-20">
          {currentSpellingWord && (
            ...
            >
              ...
              <h3 className="text-2xl font-black text-gray-400 mb-4 uppercase tracking-widest">Spell this word:</h3>
              <p className="text-6xl font-black text-green-500 mb-10 tracking-tighter">
              ...
              <div className="w-full relative">
                <input
                  ...
                  className={`w-full text-center font-geez text-5xl p-8 border-4 rounded-[2rem] outline-none transition-all mb-8 shadow-inner ${
                ...
                <AnimatePresence>
                  {spellingFeedback !== 'idle' && (
                    <motion.div 
                      ...
                      exit={{ y: -20, opacity: 0 }}
                      className={`absolute -bottom-4 left-1/2 transform -translate-x-1/2 px-6 py-2 rounded-full font-black text-white shadow-lg ${
              ...
              <motion.button
                ...
                className="w-full py-6 bg-green-500 text-white rounded-[2rem] font-black text-3xl shadow-[0_10px_0_rgb(22,163,74)] active:shadow-none active:translate-y-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-4"
              >
                CHECK SPELLING
              </motion.button>
            </motion.div>
